                ...
                {shouldShowScore && (
                  <div className="relative mt-6">
                    ...
                    >
                      ...
                      {/* Divider and Agreement Checkbox - Bottom of Card */}
                      <div className="border-t border-slate-200 mt-4 pt-4 pb-4">
                        <div className="flex items-center justify-center gap-3">
                          <div className="relative">
                            <input
                              ...
                              id="agree-score"
                              className="peer h-5 w-5 cursor-pointer appearance-none rounded border-2 border-slate-300 transition-all checked:border-0 checked:bg-gradient-to-br checked:from-purple-500 checked:to-pink-600 hover:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-500/30"
                            />
                            <svg
                          ...
                          <label
                            htmlFor="agree-score"
                            className="cursor-pointer text-sm font-medium text-slate-600 hover:text-slate-800 transition-colors"
                          >
                            我接受早期投资
                          </label>
                        </div>
